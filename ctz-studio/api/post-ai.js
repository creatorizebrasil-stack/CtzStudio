...
async function reviseCarouselCopy(body) {
  ...
  const response = await openai('/responses', {
    ...
    input: [
      { role: 'system', content: 'Você é o CTZ COPY VIRAL, especialista em textos estratégicos para carrosséis da Creatorize. Transforme o conteúdo bruto em um carrossel claro, útil, humano e fácil de consumir. Use AIDA: a primeira folha prende a Atenção com uma abertura forte e específica dentro do próprio texto; as folhas seguintes geram Interesse com uma dor, dúvida ou oportunidade reconhecível; depois criam Desejo mostrando benefício, transformação ou solução; a última conclui e traz uma Ação coerente. Preserve rigorosamente fatos, nomes, números, datas e a intenção original. Nunca invente dados, pesquisas, resultados ou promessas. Elimine frases sem informação, repetições, redundâncias, introduções longas, explicações óbvias, clichês, exageros, adjetivos excessivos, metacomentários e instruções de produção. Não use expressões genéricas como “no mundo de hoje” ou “é importante destacar”. Troque palavras difíceis por linguagem simples, divida frases longas e mantenha uma única ideia por folha. Não crie headline, título, subtítulo ou texto de apoio separado. Cada folha deve conter somente um bloco curto e contínuo de aproximadamente 15 a 30 palavras, sem linha em branco entre trechos, e despertar interesse pela próxima. Destaque com ** somente uma a três palavras-chave ou trechos curtos dentro desse texto; nunca coloque o bloco inteiro em negrito. Não use hashtags, emojis ou termos técnicos, salvo se já forem indispensáveis no conteúdo de origem. Evite aparência de texto produzido por IA e preserve naturalidade, personalidade e ritmo humano. Faça internamente uma segunda revisão e corte novamente tudo que não contribui para a mensagem central. Entregue exatamente a quantidade solicitada, na ordem narrativa, sem rótulos como “Folha”, “Capa”, “Contexto” ou explicações externas. Retorne somente o JSON solicitado.' },
...
async function generate(body) {
  const styles = {
    authority: 'Cinematic black-and-white editorial portrait advertising: one confident adult professional, centered or slightly off-center, dark neutral wardrobe, subtle film grain, controlled studio lighting, deep black background, premium personal-brand campaign. The person must be fictional and not resemble any real public or reference person.',
    tech: 'Premium monochrome technology advertising: one hero device, interface, futuristic machine or digital object, black environment, white rim light, clean geometric composition, subtle data grid, realistic materials, high-end product visualization.',
    concept: 'Cinematic black-and-white conceptual advertising: one memorable visual metaphor related to strategy, growth, branding or innovation, dramatic scale, volumetric white light, deep shadows, realistic detail, bold negative space.',
    editorial: 'Bright monochrome editorial advertising: clean white background, black and gray accents, elegant object arrangement, refined soft shadows, modern magazine layout, minimal but visually distinctive.'
  };
  ...
  const prompt = [
    ...
    styleDirection,
    'Use a strictly monochrome black, white and neutral-gray palette with no orange and no other colors. Use a polished agency-campaign look with a clear focal point and excellent visual hierarchy.',
